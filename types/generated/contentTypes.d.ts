...
export interface ApiTaskTask extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    priority: Attribute.Enumeration<['P1', 'P2', 'P3']> & Attribute.Required;
    users_permissions_users: Attribute.Relation<
      'api::task.task',
      'manyToMany',
      'plugin::users-permissions.user'
    >;
    uuid: Attribute.UID<'api::task.task', 'name'>;
    bnm: Attribute.Component<'cmp.compo', true>;
    texty: Attribute.String;
...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    tasks: Attribute.Relation<
      ...
      'api::task.task'
    >;
    owend_tasks: Attribute.Relation<
      'plugin::users-permissions.user',
      'oneToMany',
      'api::task.task'
    >;
